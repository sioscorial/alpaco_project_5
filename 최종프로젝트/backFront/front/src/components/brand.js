...
const Card = styled.div`
  width: 700px;  // 카드의 너비를 100%로 설정하여 가로로 한 개씩 표시
  padding: 16px;
  background: white;
  border-radius: 16px;
...
function App() {
  ...
  <Button onClick={handleBrandHeartClick}>
    <ButtonInner style={{ display: 'flex', alignItems: 'center' }}>
      ...
      <span style={{ fontSize: '20px', fontWeight: 'bold', marginLeft: '10px', color: 'white' }}>찜한 브랜드</span>
    </ButtonInner>
  </Button>
  <Button onClick={handleBrandSiteClick}>
    <ButtonInner style={{ display: 'flex', alignItems: 'center' }}>
      ...
      <span style={{ fontSize: '20px', fontWeight: 'bold', marginLeft: '10px', color: 'white' }}>브랜드 사이트</span>
    </ButtonInner>
  </Button>
</ButtonWrapper>
        ...
        <CategoryWrapper>
          <CategoryList>
            ...
            <CategoryButton active={selectedCategory === '카테고리1'} onClick={() => setSelectedCategory('카테고리1')}>
              <CategoryText active={selectedCategory === '카테고리1'}>상의</CategoryText>
            </CategoryButton>
            <CategoryButton active={selectedCategory === '카테고리2'} onClick={() => setSelectedCategory('카테고리2')}>
              <CategoryText active={selectedCategory === '카테고리2'}>하의</CategoryText>
            </CategoryButton>
            <CategoryButton active={selectedCategory === '카테고리3'} onClick={() => setSelectedCategory('카테고리3')}>
              <CategoryText active={selectedCategory === '카테고리3'}>아우터</CategoryText>
            </CategoryButton>
            <CategoryButton active={selectedCategory === '카테고리4'} onClick={() => setSelectedCategory('카테고리4')}>
              <CategoryText active={selectedCategory === '카테고리4'}>원피스</CategoryText>
            </CategoryButton>
            <CategoryButton active={selectedCategory === '카테고리5'} onClick={() => setSelectedCategory('카테고리5')}>
              <CategoryText active={selectedCategory === '카테고리5'}>스커트</CategoryText>
            </CategoryButton>
          </CategoryList>
        </CategoryWrapper>
        <MainContent>
